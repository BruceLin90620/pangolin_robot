...
class BasicNavigator(Node):
    ...
    def __init__(self, node_name='basic_navigator', namespace=''):
        ...
        self.localization_pose_sub = self.create_subscription(
            ...
            'pcl_pose',
            self._localizationPoseCallback,
            pose_qos,
        )
    ...
    def waitUntilNav2Active(self, navigator='bt_navigator', localizer='lidar_localization'):
    ...
    def _localizationPoseCallback(self, msg):
        self.debug('Received localization pose')
